...
var ColorInfo = (function () {
    ...
    ColorInfo.prototype.histograma = function () {
    ...
    ColorInfo.prototype.average = function () {
        var somaPixels = 0;
    ...
    ColorInfo.prototype.median = function () {
    ...
    ColorInfo.prototype.mode = function () {
        return Math.max.apply(Math, this.histograma());
    };
    ColorInfo.prototype.variance = function () {
        var sumVariance = 0;
        this.pixels.forEach(function (color) {
...
var Picture = (function () {
    ...
    Picture.prototype.histograma = function (pixels) {
        var histograma = new Array();
        for (var i = 0; i <= 255; i++) {
            histograma[i] = 0;
        }
    ...
    Picture.prototype.average = function (pixels) {
        var somaPixels = 0;
    ...
    Picture.prototype.median = function (pixels) {
        var simplePixels = new Array();
        var pixel;
        pixels.forEach(function (color, i) {
            simplePixels[i] = color.value;
    ...
    Picture.prototype.mode = function (pixels) {
        return Math.max.apply(Math, this.histograma(pixels));
    };
    Picture.prototype.variance = function (pixels) {
        var sumVariance = 0;
        pixels.forEach(function (color) {
            sumVariance += Math.pow((color.value - this.average), 2);
        });
