...
(function (ColorType) {
    ...
    ColorType[ColorType["GRAY"] = 4] = "GRAY";
})(ColorType || (ColorType = {}));
...
var ColorInfo = (function () {
    function ColorInfo(colorType, imageMatrix) {
        this.matrix = new Array();
        this.colorType = colorType;
        this.defineValues(imageMatrix);
    }
    ColorInfo.prototype.defineValues = function (imageMatrix) {
    ...
    ColorInfo.prototype.averageRightHalf = function () {
        var sum = 0, arrayLenght = 0;
        this.matrix.forEach(function (arrayX, i) {
    ...
    ColorInfo.prototype.medianLeftHalf = function () {
        var medianArray = new Array(), arrayLenght = 0;
        this.matrix.forEach(function (arrayX, i) {
            var half = Math.round(arrayX.length / 2);
    ...
    ColorInfo.prototype.modeAboveMainDiagonal = function () {
        var self = this;
...
var StatisticsView = (function (_super) {
    ...
    StatisticsView.prototype.openCharts = function () {
